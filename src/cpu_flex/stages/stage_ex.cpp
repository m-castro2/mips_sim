...
namespace mips_sim {
    ...
    int StageEX::work_h() {
        ...
        hardware_manager->add_instruction_signal(STAGE_EX, "PC", pc_value);
        ...
        hardware_manager->add_instruction_signal(STAGE_EX, "MEM_2_REG", control_unit->test(microinstruction, SIG_MEM2REG));
